...
declare -a linkedto=('caida' 'csu' 'memphis' 'neu' 'pku' 'umich' 'ucla' 'uiuc' 'wustl' 'arizona');
i=0;
...
set label "CSU\nnode down" at 30,graph(0.9,0.9) center font ",10"
set label "CSU\nnode up" at 150,graph(0.9,0.9) center font ",10"

set arrow from 40,graph(0.8,0.8) to 60,graph(0.7,0.7)
set arrow from 140,graph(0.8,0.8) to ${pkts},graph(0.7,0.7)
...
#set title "Hyperbolic Routing - 3 faces"
#unset key
#plot '$dir/hr/faces-3/$k/ping-data/$f' fc rgb "red"

#set title "Link State Routing - 3 faces"
#unset key
#plot '$dir/ls/faces-3/$k/ping-data/$f' fc rgb "blue"

#set title "Hyperbolic Routing - all faces"
#unset key
#plot '$dir/hr/faces-all/$k/ping-data/$f' fc rgb "green"

#set title "Link State Routing - all faces"
#unset key
#plot '$dir/ls/faces-all/$k/ping-data/$f' fc rgb "magenta"
