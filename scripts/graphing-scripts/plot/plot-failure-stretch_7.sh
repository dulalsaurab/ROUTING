...
set xrange [0:"$xrange"]
set grid
set ytics add ("0.1" 0.1, "0.25" 0.25, "0.5" 0.5, "0.75" 0.75, "1" 1, "1.25" 1.25, "1.5" 1.5, "1.75" 1.75, "2" 2, "2.5" 2.5, "3" 3, "3.5" 3.5, "4" 4, "4.5" 4.5, "5" 5, "5.5" 5.5, "6.5" 6.5, "7.5" 7.5)
set mytics 20
set yrange [0.75:7.5]
set logscale y
...
plot '$dir/f$face-failure-95th.stretch' title "$face next hops            95th percentile" fc rgb "black" lt -1 pi -4 pt 8 ps 1.8 w lp, \
     '$dir/f$face-failure-75th.stretch' title "75th percentile" fc rgb "black" lt -1 pi -4 pt 7 ps 1.3 w lp, \
     '$dir/f$face-failure-median.stretch' title "median" fc rgb "black" lt -1 pi -4 pt 4 ps 1.3 w lp
